...
// Forward ref is crucial for react-to-print
export const ResumePreview = React.forwardRef<HTMLDivElement, ResumePreviewProps>((props, ref) => {
    ...
    // CSS for print-specific pagination and background
    const printStyles = `
        @media print {
            @page {
                size: A4;
    ...
    return (
        <>
            ...
            <div
                ref={ref}
                className="shadow-lg w-[210mm] mx-auto flex text-sm min-h-[297mm]"
            ...
            >
                ...
                <div className="w-[65%] p-8 flex flex-col gap-6 pt-10 bg-transparent">
                ...
                <div className="w-[35%] text-white p-6 pt-10 flex flex-col gap-8 bg-transparent">
